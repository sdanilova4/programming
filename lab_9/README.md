...
![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 131256.png>)

4) Переключимся на главную ветку и выполним команду 
echo "This is an indispensable truth!" > file.txt 

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 131309.png>)

5) Закоммитим изменения в master
6) вывод git log --oneline --graph –all

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 131340.png>)

7) Использоем команду git merge чтобы смержить ветку branch1 в master 
(получим конфликт это норм)

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 165819.png>)

8) показывает git status

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 170506.png>)

9) Посмотрим содержимое файла file.txt и в любом любимом текстовом 
редакторе исправим конфликт

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 170600.png>)

10) показывает git log --oneline –graph?

![alt text](<skrin/na_5/pert_1/Снимок экрана 2025-11-28 170756.png>)

11) Запушим изменения 
Починим Merge конфликты для сортировки MergeSort на python. 
Содержимое base.py, lefty.py и righty.py находится в конце этого 
документа.
...
6) Переключаемся на main и меняем все содержимое mergesort.py на 
lefty.py 
7) Коммитим изменения.
8) Вывод git log --oneline –graph

![alt text](<skrin/na_5/part_2/Снимок экрана 2025-11-28 172756.png>)
 
9) вывод git branch

![alt text](<skrin/na_5/part_2/Снимок экрана 2025-11-28 172830.png>)

10) Смержм Mergesort-Impl в main. 

![alt text](<skrin/na_5/part_2/Снимок экрана 2025-11-28 173932.png>)

11) После исправления всех merge конфликтов запушим в main
изменения. 
12) Запушим документ с результатами работы